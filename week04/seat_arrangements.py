...
list_of_passengers = ["Fatima", "Omar", "Ben", "Evan", "Bella"]
...
for i in range(number_of_passengers):
    ...
    print(f"Passenger {list_of_passengers[i]:10} seats in {row_label}{seat_letter}")
